...
export const transactionCoordinatorFaqs = [
...
export const propertyManagementFaqs = [
...
export const virtualReceptionistFaqs = [
  ...
  { q: 'Are your receptionists bilingual?', a: 'Yes. English and Spanish (default). We can route Spanish calls to bilingual receptionists.' },
...
export const insuranceVAFaqs = [
  ...
  { q: 'Do you support multilingual operations?', a: 'Yes. 10+ languages including English and Spanish for diverse client bases.' },
