/**
 * Create missing specializations for Ruel in Webflow CMS
 * Run with: node scripts/createRuelSpecializations.js
 */
...
// Specializations to create (prioritizing the most important ones for insurance)
...
async function main() {
  try {
    console.log('🔗 Creating missing specializations for Ruel...\n');
    ...
    if (created.length > 0) {
      ...
      console.log('📌 Next step: Run node scripts/updateRuelSpecializations.js\n');
    } else {
