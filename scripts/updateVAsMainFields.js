/**
 * Update VAs with Main Category, Title, Experience, Languages, Availability, Specializations
 * Run with: node scripts/updateVAsMainFields.js
 */
...
async function main() {
  try {
    console.log('🔗 Updating VAs with main fields...\n');
