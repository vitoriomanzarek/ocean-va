/**
 * Script para recargar el Employment History de Ellen desde su HTML original
 */
...
async function main() {
  console.log('🔧 Recargando Employment History de Ellen...\n');
  
  // Leer el HTML minificado
  const htmlPath = path.join(__dirname, '..', 'webflow-components-minified', '250-ellen-profile.html');
  ...
  console.log('════════════════════════════════════════════════════════════════════════════════\n');
  const currentEmployment = ellen.fieldData['employment-richtext'] || '';
  console.log(currentEmployment.substring(0, 400) + '...\n');
  ...
  try {
    ...
    console.log('✅ Employment History de Ellen actualizado exitosamente\n');
    console.log('════════════════════════════════════════════════════════════════════════════════');
    console.log('📊 RESUMEN');
    console.log('════════════════════════════════════════════════════════════════════════════════\n');
    console.log('   ✅ Employment History: Recargado desde 250-ellen-profile.html');
