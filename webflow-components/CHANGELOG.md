# Changelog - WAGS Webflow Components
...
### ðŸ”„ Cambios
- **03-navbar-header.html**: Actualizado logo a URL relativa `/images/wags-logo.png`
- **04-hero-section.html**: Actualizado imagen a URL relativa `/images/positive-woman.jpg`
- **05-footer.html**: Actualizado logo a URL relativa `/images/wags-logo.png`
...
- **ðŸ”„ Cambios**: Cambios en funcionalidad existente
- **ðŸŽ¨ Mejorado**: Mejoras visuales o de performance
- **ðŸ› Corregido**: Bug fixes
- **ðŸ”’ Seguridad**: Fixes de seguridad
- **âš ï¸ Deprecado**: Funcionalidad que serÃ¡ removida
- **ðŸ—‘ï¸ Removido**: Funcionalidad removida
